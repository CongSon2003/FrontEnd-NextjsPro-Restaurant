...
export const GuestLoginBody = z
  .object({
    name: z.string().min(2, { message: 'Tên phải có ít nhất 2 ký tự' }).max(50),
...
export const GuestCreateOrderBody = z.array(
  z.object({
    dishId: z.number(),
    quantity: z.number()
  })
...
export type GuestCreateOrdersBodyType = z.TypeOf<typeof GuestCreateOrderBody>
