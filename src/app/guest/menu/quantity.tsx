...
export default function Quantity({ value, onChange }: { value: number; onChange: (value: number) => void }) {
  return (
    <div className='flex gap-1'>
      {/* Thêm onClick cho nút trừ */}
      ...
      {/* Đổi onChange thành onClick cho nút cộng */}
